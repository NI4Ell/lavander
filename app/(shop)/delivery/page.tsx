...
const STEPS = [
  ...
  { num: '2', title: 'Мы собираем',      text: 'флорист собирает букет и присылает вам фото (по желанию — укажите при оформлении заказа)' },
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Если вы не уверены, что получатель будет дома в выбранное время — укажите это в комментарии к заказу, и флорист свяжется с вами перед отправкой для уточнения.',
  },
  {
