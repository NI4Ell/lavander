 ...
 *
 * getBot() вызывается внутри обработчика запроса, а не на уровне модуля —
 * это гарантирует что TELEGRAM_BOT_TOKEN читается только в runtime,
 * не во время `next build`.
 */
